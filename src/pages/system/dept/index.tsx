...
export default () => {
  ...
  const columns: ProColumns<TableListItem>[] = [
    ...baseColumns,
    {
      ...
      fixed: 'right',
      render: (_text, record) => [
        <Button type="link" key="edit" onClick={() => deptUpdate(modal, record, actionRef)}>编辑</Button>,
        <Button type="link" key="delete"
                onClick={() => deleteConfirm(Api.systemDept.deptDelete, record, actionRef)}>删除</Button>
      ]
    }
  ];
