...
const DictTypeModal = NiceModal.create(({ data, type = 'add' }: { data: any; type: string }) => {
  ...
  return (
    ...
    >
      <ProForm<{
        ...
        layout="horizontal"
      >
        <ProFormText rules={[{ required: true }]} name="name" label="字典名称" />
        <ProFormText rules={[{ required: true }]} name="code" label="字典编码" />
        <ProFormRadio.Group
          name="status"
          label="状态"
          options={[
